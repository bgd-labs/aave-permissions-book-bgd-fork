  ...
  [ChainId.mainnet]: {
    ...
    pools: {
      ...
      [Pools.LIDO_TENDERLY]: {
        ...
        tenderlyBlock: 23896552,
        tenderlyRpcUrl:
          'https://virtual.mainnet.eu.rpc.tenderly.co/e30b3b7b-c801-4a0b-8445-e824e591c153',
      },
      [Pools.ETHERFI]: {
        collectorBlock: 21765718,
        permissionsJson: './statics/functionsPermissionsV3.json',
  ...
  [ChainId.polygon]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        governanceAddressBook: GovernanceV3Polygon,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 79620416,
        tenderlyRpcUrl:
          'https://virtual.polygon.eu.rpc.tenderly.co/81d24cdb-9a11-4324-a6c6-5e51aa7e8331',
      },
    },
  },
  [ChainId.bnb]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 69437435,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 69792690,
        tenderlyRpcUrl:
          'https://virtual.binance.eu.rpc.tenderly.co/f1fb4ab5-d72d-4b00-9387-725511b8ae90',
      },
    },
  },
  [ChainId.avalanche]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 72564515,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 72745140,
        tenderlyRpcUrl:
          'https://virtual.avalanche.eu.rpc.tenderly.co/567124e7-eb8b-4ce9-b7ce-6134ee1d848a',
      },
    },
  },
  [ChainId.optimism]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 144240778,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 144373809,
        tenderlyRpcUrl:
          'https://virtual.optimism.eu.rpc.tenderly.co/7e9e33a8-72ea-4d79-b2d2-b26e29b6be42',
      },
    },
  },
  [ChainId.arbitrum]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 403986850,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 405060517,
        tenderlyRpcUrl:
          'https://virtual.arbitrum.eu.rpc.tenderly.co/e4677679-04c8-419e-b9b1-51279a9f3ac9',
      },
    },
  },
  [ChainId.metis]: {
  ...
  [ChainId.base]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 38644854,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 38778663,
        tenderlyRpcUrl:
          'https://virtual.base.eu.rpc.tenderly.co/56878790-da23-4b85-8e51-cbccf0de5abd',
      },
    },
  },
  [ChainId.gnosis]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        functionsPermissionsAgentHubJson: './statics/functionsPermissionsAgentHub.json',
        agentHubBlock: 43326597,
        tenderlyBlock: 43378535,
        tenderlyRpcUrl:
          'https://virtual.gnosis.eu.rpc.tenderly.co/e958f2a3-d7b3-4730-bd64-ff3058016b58',
      },
    },
  },
  [ChainId.scroll]: {
  ...
  [ChainId.linea]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 26013390,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 26124543,
        tenderlyRpcUrl:
          'https://virtual.linea.eu.rpc.tenderly.co/e7b6abf4-29b5-4f04-bafe-026e8d8120c0',
      },
    },
  },
  [ChainId.celo]: {
  ...
  [ChainId.plasma]: {
    ...
    pools: {
      ...
      [Pools.TENDERLY]: {
        ...
        agentHubBlock: 7150621,
        tenderlyBasePool: Pools.V3,
        tenderlyBlock: 7416381,
        tenderlyRpcUrl:
          'https://virtual.plasma.eu.rpc.tenderly.co/c303180e-27f2-4e04-b340-1423854030a5',
      },
    },
  },
  [ChainId.bob]: {
